...
namespace ShareInvest.Server.Areas.Identity.Pages.Account.Manage
{
    ...
    {
        public GenerateRecoveryCodesModel(UserManager<CoreUser> userManager, ILogger<GenerateRecoveryCodesModel> logger)
        {
        ...
        readonly ILogger<GenerateRecoveryCodesModel> logger;
    }
}